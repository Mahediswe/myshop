...
//               {item.name} - {item.qty} x Tk {item.price}
//             </li>
//           ))}
//         </ul>
//       )}
...
//       {/* Sidebar */}
//       <div
//         className={`fixed top-0 right-0 h-full w-full md:w-96 bg-white shadow-2xl transform transition-transform duration-300 ${
//           isCartOpen ? "translate-x-0" : "translate-x-full"
//         }`}
//         style={{ zIndex: 1000 }} // Ensure cart has higher z-index than navbar
//       >
//         <div className="flex flex-col h-full">
//           {/* Header */}
//           <div className="flex justify-between items-center p-4 border-b">
            ...
            {cart.length === 0 ? (
              ...
              <div className="space-y-4">
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center p-3 bg-gray-50 rounded-lg border gap-3"
                  >
                    {/* Product Image */}
<div className="flex-shrink-0">
  <img
    src={item.image} // যদি image না থাকে, /public/placeholder.png ব্যবহার হবে
    alt={item.name}
