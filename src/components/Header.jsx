...
//   return (
//     <header className="max-w-7xl mx-auto bg-gray-100 w-full">
...
//               className="border rounded-lg px-3 py-1 focus:outline-none focus:ring-2 focus:ring-orange-400 w-40 lg:w-64"
//             />
//           </div>
...
//               <User className="text-orange-500 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
...
//             >
//               <ShoppingBag className="text-orange-500 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
//               <span className="hidden md:block text-xs text-orange-500 opacity-0 group-hover:opacity-100 transition">
//                 Cart
//               </span>
//             </button>
