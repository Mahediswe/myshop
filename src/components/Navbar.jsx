...
const Navbar = () => {
  ...
  const handleMenuHover = (menu) => {
    if (window.innerWidth >= 768) { // শুধু desktop এ hover কাজ করবে
      setActiveMenu(menu);
    }
  };
  ...
  const handleSubmenuClick = (menu) => {
    // mobile এ click করলে submenu toggle হবে
    if (window.innerWidth < 768) {
          ...
          <ul className="flex flex-col md:flex-row md:space-x-8 font-medium py-4 md:py-0">
              ...
              >
                ...
                <li>
                  <Link
                    ...
                    className="block px-6 py-3 hover:bg-blue-50 text-gray-800"
                  >
                    নদীর মাছ
                  </Link>
                </li>
            ...
            <li>
              <Link
                ...
                className="block px-6 md:px-0 py-3 md:py-4 text-white hover:text-blue-200 font-semibold text-lg"
              >
                ওষুধ
              </Link>
            </li>
